class Arc{
    ...
    novy_svg_arc(element, app, undefined, xmlns, zaciatok, koniec) {
        ...
        if (element.arctype === "inhibitor") {
            ...
            svgelement2.setAttributeNS(null, "cx", Arc.bodInhibitorSipky(zaciatok.x, zaciatok.y, koniec.x, koniec.y).x);
            svgelement2.setAttributeNS(null, "cy", Arc.bodInhibitorSipky(zaciatok.x, zaciatok.y, koniec.x, koniec.y).y);
            ...
            svgelement2.setAttributeNS(null, "points", Arc.bodySipky(zaciatok.x, zaciatok.y, koniec.x, koniec.y, element.arctype));
        ...
        let bodvaha = Arc.bodvahy(zaciatok, koniec);
    ...
    static novy_svg_temp_arc(canvas, xmlns, zaciatok, koniec, arctype) {
        ...
        if (arctype === "inhibitor") {
            ...
            svgelement2 = document.createElementNS(xmlns, "polygon");
            svgelement2.setAttributeNS(null, "points", Arc.bodySipky(zaciatok.x, zaciatok.y, koniec.x, koniec.y, arctype));
            svgelement2.setAttributeNS(null, "fill", "blue");
    ...
    skrattemphranu(zaciatok, koniec) {
        let dx = koniec.x - zaciatok.x;
        let dy = koniec.y - zaciatok.y;
        let dlzkahrany = Math.sqrt(dx * dx + dy * dy);
        let dlzkaskratena = dlzkahrany - arrowHeadSize + 2;
    ...
    static bodInhibitorSipky(startPoint_x, startPoint_y, endPoint_x, endPoint_y) {
    ...
    static bodySipky(startPoint_x, startPoint_y, endPoint_x, endPoint_y, arctype) {
    ...
    static zaciatok_hrany(startElement, endElement) {
    ...
    static koniec_hrany(startElement, endElement) {
