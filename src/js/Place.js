class Place {
    ...
    constructor(x, y, isStatic, canvas, id) {
        this.type = "place";
        ...
        this.markinglabel = "";
        this.markingtokens = [];
        this.objektymiesta = this.novy_svg_place(this, canvas, xmlns, x, y, this.polomer);
    }
    ...
    novy_svg_place(element, canvas, xmlns, x, y, polomer) {
        ...
        svgelement.onmousedown = function () {
            element.onplacedown(element, canvas, svgelement, svgmeno, labelnode, svgmarking, markingnode, svgzamenom)
        };
    ...
    onplacedown(element, canvas, svgelement, svgmeno, labelnode, svgmarking, markingnode, svgzamenom) {
        ...
        if (document.getElementById("arc").checked) {
            if (kresli_sa_hrana === 0) {
                ...
                if (source_hrany.type !== element.type) {
                    ...
                    Arc.elementypredhrany(canvas, element);
        ...
        if (document.getElementById("marking").checked) {
            previousStatus = generujXML(1);
            element.updatemarkingsvg(element);
        }
